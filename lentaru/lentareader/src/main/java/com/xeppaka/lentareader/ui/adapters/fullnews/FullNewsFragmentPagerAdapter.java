 ...
 */
public class FullNewsFragmentPagerAdapter extends FullFragmentPagerAdapter {
    public FullNewsFragmentPagerAdapter(FragmentManager fm, List<Long> ids) {
        super(fm, ids);
    }

    @Override
    public FullFragmentBase createFragment() {
        return new NewsFullFragment();
    }
}
