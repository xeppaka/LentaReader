...
public class PreferencesConstants {
    public static final String PREF_KEY_DOWNLOAD_IMAGE_THUMBNAILS = "pref_key_load_image_thumbnails";
    public static final String PREF_KEY_DOWNLOAD_IMAGE_FULL = "pref_key_load_image_full";
    public static final String PREF_KEY_NEWS_DELETE_NEWS = "pref_key_news_delete";
    public static final String PREF_KEY_NEWS_DELETE_NEWS_DAYS = "pref_key_news_delete_days";
    public static final String PREF_KEY_ARTICLE_DELETE_ARTICLES = "pref_key_article_delete";
    public static final String PREF_KEY_ARTICLE_DELETE_ARTICLE_DAYS = "pref_key_article_delete_days";
    ...
    public static final int ARTICLE_DELETE_ARTICLES_DAYS_DEFAULT = 20;
    ...
    public static final boolean ARTICLE_DELETE_ARTICLES_DEFAULT = true;
}
